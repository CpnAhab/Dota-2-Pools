export const heroes = [
    ["abaddon", "alchemist", "axe", "beastmaster", "brewmaster", "bristleback", "centaur", "chaos_knight", "rattletrap", "dawnbreaker", "doom_bringer", "dragon_knight", "earth_spirit", 
        "earthshaker", "elder_titan", "huskar", "wisp", "kunkka", "legion_commander", "life_stealer", "lycan", "magnataur", "marci", "mars", "night_stalker", "omniknight", "phoenix", "pudge", 
        "sand_king", "slardar", "snapfire", "spirit_breaker", "sven", "tidehunter", "shredder", "tiny", "treant", "tusk", "abyssal_underlord", "undying", "skeleton_king"],
